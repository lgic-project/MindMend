      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4"> "Empowering you to live your best life, everyday"</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2"> Daily Mood tracking</h4>
              <p className="text-lg text-gray-400 text-center">The app could allow users to track their dailymood and provide insights into patterns.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Personalized Recommendation</h4>
              <p className="text-lg text-gray-400 text-center">The app could use AI and Machine learning to provide personalized recommendation for exercise, user history and workouts.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400 text-center">The app could allow user to share their issues and their experience with different community, helping to raise awarness and reduce stigma.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Mindfulness Exercise</h4>
              <p className="text-lg text-gray-400 text-center">The app could offer mindfulness exercises, such as: meditation, breathing techniques.</p>
            </div>
